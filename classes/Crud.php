<!-- La classe Crud fournit une connexion à la base de données et des méthodes CRUD. -->
...
class Crud extends PDO
{
    ...
    {
        parent::__construct('mysql:host=localhost;dbname=myblog', "root", "");
    }
    ...
    public function select($table, $champOrdre = 'id', $ordre = 'DESC')
    {
        if ($champOrdre == null) {
